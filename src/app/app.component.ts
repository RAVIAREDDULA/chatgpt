...
export class AppComponent {
  ...
  changedtext:any;
  time = new Date();
  storageKey = 'user-valid-count';
  storageKey1='user-invalid-count';
 ...
 contactsForm=new FormGroup({  
   ...
   ngOnInit():void
    {
      //var val=localStorage.getItem("storedata");
     // console.log(val);
    }
    
    /*ngOnDestroy()
    {
      var countdata=this.count;
      localStorage.setItem("storedata",countdata);
