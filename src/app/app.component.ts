...
export class AppComponent {
 ...
 //public isEdit = false;
  ...
  options=[ {src:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTE1LfcxsSCgnSuI663-3IK6x_GRknUw8K87G_PBbnj5Q&s'},
            {src:'https://png.pngtree.com/png-vector/20190701/ourmid/pngtree-robot-icon-for-your-project-png-image_1533288.jpg'},
            {src:'data:image/jpeg;base64,'},
          ];
  ...
  stopService(){
    this.service.stop();
    this.filterBy = this.service.text[0];
    this.filter();
  }
 ...
 contactsForm=new FormGroup({  
     ...
     cphno:new FormControl("",[Validators.required])
    ...
    {
      //localStorage.clear();
      this.count=localStorage.getItem("storedata");
      this.validcount=localStorage.getItem("storevaliddata")
      this.total=parseInt(this.count)+parseInt(this.validcount);
    ...
    ngOnDestroy()
    {
      ...
      //localStorage.setItem("storedata",this.count);
    ...
    botbackgroundcolor($event:any)
    {
      ...
      this.element.style.backgroundColor=this.selectedname;

    }
    chagefont($event:any)
    {
      this.element=document.getElementById("myDIV");
      this.element.style.fontFamily=this.changedtext;
 ...
 { 
    ...
    {
    this.cdata.push(this.contactsForm.value);
...
filter() {
  ...
  this.questions = this.book.filter(qname =>qname.name.toLowerCase().includes(this.filterBy.toLowerCase()));
   ...
   if(this.questions.length>0) 
   {
    ...
    localStorage.setItem("storevaliddata",this.validcount);
  ...
  this.filterBy = '';
   ...
   this.total=parseInt(this.validcount)+parseInt(this.count);
}
...
{
this.element=document.getElementById("myDIV");
this.element1=document.getElementById("sendmesg");
...
this.message = [];
  ...
  book = [
        ...
        {
      name: 'how are you doing ',description: 'I am doing absolutely great. How are you doing?'},
    { name: 'good morning', description: 'very good Morning' },
    { name: 'good after noon', description: 'very good afternoon' },
    { name: 'good evening', description: 'good evening' },
    { name: 'good night', description: ' good night' },

    { name: 'hi', description: 'hello'},
    { name: 'thank you', description: 'You are Welcome' },
    ...
    { name: 'Who are you', description: 'Hi , My name is Agular Bot' },
    {
      name: 'happy birthday!',
      description:
    ...
    },
    {
      ...
      description: 'I cant Promise, but I will try my best. ',
    },
    { name: 'do you like people?', description: 'Yes! I do Like people' },
    {
      name: 'does santa claus exist?',
      description:' Its a childrens book character. No It does not exist in reality',
    },
    {
